...
namespace Org.OpenAPITools.Api
{
    ...
    public interface IAccountApiSync : IApiAccessor
    {
        ...
        /// <param name="americommerceAppId">Americommerce App ID (optional)</param>
        /// <param name="americommerceAppSecret">Americommerce App Secret (optional)</param>
        /// <param name="americommerceAccessToken">Americommerce Access Token (optional)</param>
        /// <param name="americommerceRefreshToken">Americommerce Refresh Token (optional)</param>
        ...
        /// <param name="shopifyClientId">Shopify Client ID (optional)</param>
        ...
        /// <param name="shopeePartnerId">Shopee Partner ID (optional)</param>
        /// <param name="shopeePartnerKey">Shopee Partner Key (optional)</param>
        /// <param name="shopeeShopId">Shopee SHOP ID (optional)</param>
        /// <param name="shopeeRefreshToken">Shopee Refresh Token (optional)</param>
        /// <param name="shopeeRegion">Shopee API endpoint Region. Use for Chinese Mainland or Brazil. (optional)</param>
        /// <param name="shopeeEnvironment">Shopee Environment (optional)</param>
        ...
        /// <param name="miraklApiKey">Mirakl API Key (optional)</param>
        /// <param name="shopwareAccessKey">Shopware access key (optional)</param>
        /// <param name="unasApiKey">UNAS API Key (optional)</param>
        ...
        /// <param name="bricklinkConsumerKey">Bricklink Consumer Key (optional)</param>
        /// <param name="bricklinkConsumerSecret">Bricklink Consumer Secret (optional)</param>
        /// <param name="bricklinkToken">Bricklink Access Token (optional)</param>
        /// <param name="bricklinkTokenSecret">Bricklink Access Token Secret (optional)</param>
        /// <param name="nopcommerceToken">Access token authorizing the app to access resources on behalf of a user (optional)</param>
        /// <param name="nopcommerceSecret">nopCommerce webhook signing secret generated by the Api2Cart.Connector plugin. Optional when connecting a store, but required to receive webhooks from it. (optional)</param>
        ...
        /// <param name="walmartRefreshToken">Walmart refresh token received by a Solution Provider application through the Walmart App Store authorization. When it is set, walmart_client_id and walmart_client_secret are the credentials of that application, not of the seller. Must be used together with walmart_seller_id and is supported only for walmart_region &#x3D; &#39;us&#39; (optional)</param>
        /// <param name="walmartSellerId">Walmart seller id the refresh token was issued for, sent as the WM_PARTNER.ID header. Must be used together with walmart_refresh_token and is supported only for walmart_region &#x3D; &#39;us&#39; (optional)</param>
        ...
        /// <param name="jumpsellerClientId">Jumpseller OAuth2 Client ID (optional)</param>
        /// <param name="jumpsellerClientSecret">Jumpseller OAuth2 Client Secret (optional)</param>
        /// <param name="jumpsellerRefreshToken">Jumpseller OAuth2 refresh token (optional)</param>
        /// <param name="jumpsellerLogin">Jumpseller API login (optional)</param>
        /// <param name="jumpsellerAuthtoken">Jumpseller API auth token (optional)</param>
        ...
        /// <param name="temuAppKey">Temu App Key (optional)</param>
        /// <param name="temuAppSecret">Temu App Secret (optional)</param>
        /// <param name="temuAccessToken">Temu Access Token (optional)</param>
        /// <param name="temuRegion">Temu API endpoint Region. (optional)</param>
        /// <param name="scapiClientId">Salesforce Commerce API Client ID (optional)</param>
        /// <param name="scapiClientSecret">Salesforce Commerce API Client Secret (optional)</param>
        /// <param name="scapiOrganizationId">Salesforce Commerce Organization ID (optional)</param>
        /// <param name="scapiShortCode">Salesforce Commerce Short Code (optional)</param>
        /// <param name="scapiScopes">Salesforce Commerce API Scopes (optional)</param>
    ...
    public interface IAccountApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<AccountConfigUpdate200Response> AccountConfigUpdateAsync(bool? replaceParameters = default(bool?), string? newStoreUrl = default(string?), string? newStoreKey = default(string?), string? customLabel = default(string?), string? bridgeUrl = default(string?), string? storeRoot = default(string?), string? dbTablesPrefix = default(string?), string? userAgent = default(string?), string? var3dcartPrivateKey = default(string?), string? var3dcartAccessToken = default(string?), string? var3dcartapiApiKey = default(string?), string? amazonSpClientId = default(string?), string? amazonSpClientSecret = default(string?), string? amazonSpRefreshToken = default(string?), string? amazonSpAwsRegion = default(string?), string? amazonSpApiEnvironment = default(string?), string? amazonSellerId = default(string?), string? aspdotnetstorefrontApiUser = default(string?), string? aspdotnetstorefrontApiPass = default(string?), string? americommerceAppId = default(string?), string? americommerceAppSecret = default(string?), string? americommerceAccessToken = default(string?), string? americommerceRefreshToken = default(string?), string? bigcommerceapiAdminAccount = default(string?), string? bigcommerceapiApiPath = default(string?), string? bigcommerceapiApiKey = default(string?), string? bigcommerceapiClientId = default(string?), string? bigcommerceapiAccessToken = default(string?), string? bigcommerceapiContext = default(string?), string? bolApiKey = default(string?), string? bolApiSecret = default(string?), int? bolRetailerId = default(int?), string? demandwareClientId = default(string?), string? demandwareApiPassword = default(string?), string? demandwareUserName = default(string?), string? demandwareUserPassword = default(string?), string? ebayClientId = default(string?), string? ebayClientSecret = default(string?), string? ebayRuname = default(string?), string? ebayAccessToken = default(string?), string? ebayRefreshToken = default(string?), string? ebayEnvironment = default(string?), int? ebaySiteId = default(int?), string? ecwidAcessToken = default(string?), string? ecwidStoreId = default(string?), string? lazadaAppId = default(string?), string? lazadaAppSecret = default(string?), string? lazadaRefreshToken = default(string?), string? lazadaRegion = default(string?), string? etsyKeystring = default(string?), string? etsySharedSecret = default(string?), string? etsyAccessToken = default(string?), string? etsyTokenSecret = default(string?), string? etsyClientId = default(string?), string? etsyRefreshToken = default(string?), string? facebookAppId = default(string?), string? facebookAppSecret = default(string?), string? facebookAccessToken = default(string?), string? facebookBusinessId = default(string?), string? netoApiKey = default(string?), string? netoApiUsername = default(string?), string? shoplineAccessToken = default(string?), string? shoplineAppKey = default(string?), string? shoplineAppSecret = default(string?), string? shoplineSharedSecret = default(string?), string? shopifyAccessToken = default(string?), string? shopifyClientId = default(string?), string? shopifyApiKey = default(string?), string? shopifyApiPassword = default(string?), string? shopifySharedSecret = default(string?), string? shopeePartnerId = default(string?), string? shopeePartnerKey = default(string?), string? shopeeShopId = default(string?), string? shopeeRefreshToken = default(string?), string? shopeeRegion = default(string?), string? shopeeEnvironment = default(string?), string? shoplazzaAccessToken = default(string?), string? shoplazzaSharedSecret = default(string?), string? mivaAccessToken = default(string?), string? mivaSignature = default(string?), string? miraklApiKey = default(string?), string? shopwareAccessKey = default(string?), string? unasApiKey = default(string?), string? shopwareApiKey = default(string?), string? shopwareApiSecret = default(string?), string? bigcartelUserName = default(string?), string? bigcartelPassword = default(string?), string? bricklinkConsumerKey = default(string?), string? bricklinkConsumerSecret = default(string?), string? bricklinkToken = default(string?), string? bricklinkTokenSecret = default(string?), string? nopcommerceToken = default(string?), string? nopcommerceSecret = default(string?), string? volusionLogin = default(string?), string? volusionPassword = default(string?), string? walmartClientId = default(string?), string? walmartClientSecret = default(string?), string? walmartEnvironment = default(string?), string? walmartChannelType = default(string?), string? walmartRegion = default(string?), string? walmartRefreshToken = default(string?), string? walmartSellerId = default(string?), string? squareClientId = default(string?), string? squareClientSecret = default(string?), string? squareRefreshToken = default(string?), string? squarespaceApiKey = default(string?), string? squarespaceClientId = default(string?), string? squarespaceClientSecret = default(string?), string? squarespaceAccessToken = default(string?), string? squarespaceRefreshToken = default(string?), string? hybrisClientId = default(string?), string? hybrisClientSecret = default(string?), string? hybrisUsername = default(string?), string? hybrisPassword = default(string?), List<string>? hybrisWebsites = default(List<string>?), string? lightspeedApiKey = default(string?), string? lightspeedApiSecret = default(string?), string? commercehqApiKey = default(string?), string? commercehqApiPassword = default(string?), string? wcConsumerKey = default(string?), string? wcConsumerSecret = default(string?), string? magentoConsumerKey = default(string?), string? magentoConsumerSecret = default(string?), string? magentoAccessToken = default(string?), string? magentoTokenSecret = default(string?), string? prestashopWebserviceKey = default(string?), string? wixAppId = default(string?), string? wixAppSecretKey = default(string?), string? wixInstanceId = default(string?), string? wixRefreshToken = default(string?), string? mercadoLibreAppId = default(string?), string? mercadoLibreAppSecretKey = default(string?), string? mercadoLibreRefreshToken = default(string?), int? zidClientId = default(int?), string? zidClientSecret = default(string?), string? zidAccessToken = default(string?), string? zidAuthorization = default(string?), string? zidRefreshToken = default(string?), string? jumpsellerClientId = default(string?), string? jumpsellerClientSecret = default(string?), string? jumpsellerRefreshToken = default(string?), string? jumpsellerLogin = default(string?), string? jumpsellerAuthtoken = default(string?), string? flipkartClientId = default(string?), string? flipkartClientSecret = default(string?), string? allegroClientId = default(string?), string? allegroClientSecret = default(string?), string? allegroAccessToken = default(string?), string? allegroRefreshToken = default(string?), string? allegroEnvironment = default(string?), string? zohoClientId = default(string?), string? zohoClientSecret = default(string?), string? zohoRefreshToken = default(string?), string? zohoRegion = default(string?), int? tiendanubeUserId = default(int?), string? tiendanubeAccessToken = default(string?), string? tiendanubeClientSecret = default(string?), string? ottoClientId = default(string?), string? ottoClientSecret = default(string?), string? ottoAppId = default(string?), string? ottoRefreshToken = default(string?), string? ottoEnvironment = default(string?), string? ottoAccessToken = default(string?), string? tiktokshopAppKey = default(string?), string? tiktokshopAppSecret = default(string?), string? tiktokshopRefreshToken = default(string?), string? tiktokshopAccessToken = default(string?), string? sallaClientId = default(string?), string? sallaClientSecret = default(string?), string? sallaRefreshToken = default(string?), string? sallaAccessToken = default(string?), string? temuAppKey = default(string?), string? temuAppSecret = default(string?), string? temuAccessToken = default(string?), string? temuRegion = default(string?), string? scapiClientId = default(string?), string? scapiClientSecret = default(string?), string? scapiOrganizationId = default(string?), string? scapiShortCode = default(string?), string? scapiScopes = default(string?), string? idempotencyKey = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
    ...
    public partial class AccountApi : IAccountApi
    {
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<AccountCartList200Response> localVarResponse = AccountCartListWithHttpInfo(storeUrl, storeKey, requestFromDate, requestToDate, customLabel, varParams, exclude);
            return localVarResponse.Data;
        }
        ...
        public Org.OpenAPITools.Client.ApiResponse<AccountCartList200Response> AccountCartListWithHttpInfo(string? storeUrl = default(string?), string? storeKey = default(string?), string? requestFromDate = default(string?), string? requestToDate = default(string?), string? customLabel = default(string?), string? varParams = default(string?), string? exclude = default(string?), int operationIndex = 0)
        {
            ...
            if (customLabel != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "custom_label", customLabel));
            }
            if (varParams != null)
            {
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<AccountCartList200Response> localVarResponse = await AccountCartListWithHttpInfoAsync(storeUrl, storeKey, requestFromDate, requestToDate, customLabel, varParams, exclude, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public Org.OpenAPITools.Client.ApiResponse<AccountConfigUpdate200Response> AccountConfigUpdateWithHttpInfo(bool? replaceParameters = default(bool?), string? newStoreUrl = default(string?), string? newStoreKey = default(string?), string? customLabel = default(string?), string? bridgeUrl = default(string?), string? storeRoot = default(string?), string? dbTablesPrefix = default(string?), string? userAgent = default(string?), string? var3dcartPrivateKey = default(string?), string? var3dcartAccessToken = default(string?), string? var3dcartapiApiKey = default(string?), string? amazonSpClientId = default(string?), string? amazonSpClientSecret = default(string?), string? amazonSpRefreshToken = default(string?), string? amazonSpAwsRegion = default(string?), string? amazonSpApiEnvironment = default(string?), string? amazonSellerId = default(string?), string? aspdotnetstorefrontApiUser = default(string?), string? aspdotnetstorefrontApiPass = default(string?), string? americommerceAppId = default(string?), string? americommerceAppSecret = default(string?), string? americommerceAccessToken = default(string?), string? americommerceRefreshToken = default(string?), string? bigcommerceapiAdminAccount = default(string?), string? bigcommerceapiApiPath = default(string?), string? bigcommerceapiApiKey = default(string?), string? bigcommerceapiClientId = default(string?), string? bigcommerceapiAccessToken = default(string?), string? bigcommerceapiContext = default(string?), string? bolApiKey = default(string?), string? bolApiSecret = default(string?), int? bolRetailerId = default(int?), string? demandwareClientId = default(string?), string? demandwareApiPassword = default(string?), string? demandwareUserName = default(string?), string? demandwareUserPassword = default(string?), string? ebayClientId = default(string?), string? ebayClientSecret = default(string?), string? ebayRuname = default(string?), string? ebayAccessToken = default(string?), string? ebayRefreshToken = default(string?), string? ebayEnvironment = default(string?), int? ebaySiteId = default(int?), string? ecwidAcessToken = default(string?), string? ecwidStoreId = default(string?), string? lazadaAppId = default(string?), string? lazadaAppSecret = default(string?), string? lazadaRefreshToken = default(string?), string? lazadaRegion = default(string?), string? etsyKeystring = default(string?), string? etsySharedSecret = default(string?), string? etsyAccessToken = default(string?), string? etsyTokenSecret = default(string?), string? etsyClientId = default(string?), string? etsyRefreshToken = default(string?), string? facebookAppId = default(string?), string? facebookAppSecret = default(string?), string? facebookAccessToken = default(string?), string? facebookBusinessId = default(string?), string? netoApiKey = default(string?), string? netoApiUsername = default(string?), string? shoplineAccessToken = default(string?), string? shoplineAppKey = default(string?), string? shoplineAppSecret = default(string?), string? shoplineSharedSecret = default(string?), string? shopifyAccessToken = default(string?), string? shopifyClientId = default(string?), string? shopifyApiKey = default(string?), string? shopifyApiPassword = default(string?), string? shopifySharedSecret = default(string?), string? shopeePartnerId = default(string?), string? shopeePartnerKey = default(string?), string? shopeeShopId = default(string?), string? shopeeRefreshToken = default(string?), string? shopeeRegion = default(string?), string? shopeeEnvironment = default(string?), string? shoplazzaAccessToken = default(string?), string? shoplazzaSharedSecret = default(string?), string? mivaAccessToken = default(string?), string? mivaSignature = default(string?), string? miraklApiKey = default(string?), string? shopwareAccessKey = default(string?), string? unasApiKey = default(string?), string? shopwareApiKey = default(string?), string? shopwareApiSecret = default(string?), string? bigcartelUserName = default(string?), string? bigcartelPassword = default(string?), string? bricklinkConsumerKey = default(string?), string? bricklinkConsumerSecret = default(string?), string? bricklinkToken = default(string?), string? bricklinkTokenSecret = default(string?), string? nopcommerceToken = default(string?), string? nopcommerceSecret = default(string?), string? volusionLogin = default(string?), string? volusionPassword = default(string?), string? walmartClientId = default(string?), string? walmartClientSecret = default(string?), string? walmartEnvironment = default(string?), string? walmartChannelType = default(string?), string? walmartRegion = default(string?), string? walmartRefreshToken = default(string?), string? walmartSellerId = default(string?), string? squareClientId = default(string?), string? squareClientSecret = default(string?), string? squareRefreshToken = default(string?), string? squarespaceApiKey = default(string?), string? squarespaceClientId = default(string?), string? squarespaceClientSecret = default(string?), string? squarespaceAccessToken = default(string?), string? squarespaceRefreshToken = default(string?), string? hybrisClientId = default(string?), string? hybrisClientSecret = default(string?), string? hybrisUsername = default(string?), string? hybrisPassword = default(string?), List<string>? hybrisWebsites = default(List<string>?), string? lightspeedApiKey = default(string?), string? lightspeedApiSecret = default(string?), string? commercehqApiKey = default(string?), string? commercehqApiPassword = default(string?), string? wcConsumerKey = default(string?), string? wcConsumerSecret = default(string?), string? magentoConsumerKey = default(string?), string? magentoConsumerSecret = default(string?), string? magentoAccessToken = default(string?), string? magentoTokenSecret = default(string?), string? prestashopWebserviceKey = default(string?), string? wixAppId = default(string?), string? wixAppSecretKey = default(string?), string? wixInstanceId = default(string?), string? wixRefreshToken = default(string?), string? mercadoLibreAppId = default(string?), string? mercadoLibreAppSecretKey = default(string?), string? mercadoLibreRefreshToken = default(string?), int? zidClientId = default(int?), string? zidClientSecret = default(string?), string? zidAccessToken = default(string?), string? zidAuthorization = default(string?), string? zidRefreshToken = default(string?), string? jumpsellerClientId = default(string?), string? jumpsellerClientSecret = default(string?), string? jumpsellerRefreshToken = default(string?), string? jumpsellerLogin = default(string?), string? jumpsellerAuthtoken = default(string?), string? flipkartClientId = default(string?), string? flipkartClientSecret = default(string?), string? allegroClientId = default(string?), string? allegroClientSecret = default(string?), string? allegroAccessToken = default(string?), string? allegroRefreshToken = default(string?), string? allegroEnvironment = default(string?), string? zohoClientId = default(string?), string? zohoClientSecret = default(string?), string? zohoRefreshToken = default(string?), string? zohoRegion = default(string?), int? tiendanubeUserId = default(int?), string? tiendanubeAccessToken = default(string?), string? tiendanubeClientSecret = default(string?), string? ottoClientId = default(string?), string? ottoClientSecret = default(string?), string? ottoAppId = default(string?), string? ottoRefreshToken = default(string?), string? ottoEnvironment = default(string?), string? ottoAccessToken = default(string?), string? tiktokshopAppKey = default(string?), string? tiktokshopAppSecret = default(string?), string? tiktokshopRefreshToken = default(string?), string? tiktokshopAccessToken = default(string?), string? sallaClientId = default(string?), string? sallaClientSecret = default(string?), string? sallaRefreshToken = default(string?), string? sallaAccessToken = default(string?), string? temuAppKey = default(string?), string? temuAppSecret = default(string?), string? temuAccessToken = default(string?), string? temuRegion = default(string?), string? scapiClientId = default(string?), string? scapiClientSecret = default(string?), string? scapiOrganizationId = default(string?), string? scapiShortCode = default(string?), string? scapiScopes = default(string?), string? idempotencyKey = default(string?), int operationIndex = 0)
        {
            ...
            if (americommerceAppId != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "americommerce_app_id", americommerceAppId));
            }
            if (americommerceAppSecret != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "americommerce_app_secret", americommerceAppSecret));
            }
            if (americommerceAccessToken != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "americommerce_access_token", americommerceAccessToken));
            }
            if (americommerceRefreshToken != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "americommerce_refresh_token", americommerceRefreshToken));
            }
            ...
            if (shopifyClientId != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "shopify_client_id", shopifyClientId));
            }
            ...
            if (shopeePartnerId != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "shopee_partner_id", shopeePartnerId));
            }
            if (shopeePartnerKey != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "shopee_partner_key", shopeePartnerKey));
            }
            if (shopeeShopId != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "shopee_shop_id", shopeeShopId));
            }
            if (shopeeRefreshToken != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "shopee_refresh_token", shopeeRefreshToken));
            }
            if (shopeeRegion != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "shopee_region", shopeeRegion));
            }
            if (shopeeEnvironment != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "shopee_environment", shopeeEnvironment));
            }
            ...
            if (miraklApiKey != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "mirakl_api_key", miraklApiKey));
            }
            ...
            if (unasApiKey != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "unas_api_key", unasApiKey));
            }
            ...
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "bricklink_consumer_key", bricklinkConsumerKey));
            }
            if (bricklinkConsumerSecret != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "bricklink_consumer_secret", bricklinkConsumerSecret));
            }
            if (bricklinkToken != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "bricklink_token", bricklinkToken));
            }
            if (bricklinkTokenSecret != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "bricklink_token_secret", bricklinkTokenSecret));
            }
            if (nopcommerceToken != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "nopcommerce_token", nopcommerceToken));
            }
            if (nopcommerceSecret != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "nopcommerce_secret", nopcommerceSecret));
            }
            ...
            if (walmartRefreshToken != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "walmart_refresh_token", walmartRefreshToken));
            }
            if (walmartSellerId != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "walmart_seller_id", walmartSellerId));
            }
            ...
            if (jumpsellerClientId != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "jumpseller_client_id", jumpsellerClientId));
            }
            if (jumpsellerClientSecret != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "jumpseller_client_secret", jumpsellerClientSecret));
            }
            if (jumpsellerRefreshToken != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "jumpseller_refresh_token", jumpsellerRefreshToken));
            }
            if (jumpsellerLogin != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "jumpseller_login", jumpsellerLogin));
            }
            if (jumpsellerAuthtoken != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "jumpseller_authtoken", jumpsellerAuthtoken));
            }
            ...
            if (temuAppKey != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "temu_app_key", temuAppKey));
            }
            if (temuAppSecret != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "temu_app_secret", temuAppSecret));
            }
            if (temuAccessToken != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "temu_access_token", temuAccessToken));
            }
            if (temuRegion != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "temu_region", temuRegion));
            }
            if (scapiClientId != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "scapi_client_id", scapiClientId));
            }
            if (scapiClientSecret != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "scapi_client_secret", scapiClientSecret));
            }
            if (scapiOrganizationId != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "scapi_organization_id", scapiOrganizationId));
            }
            if (scapiShortCode != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "scapi_short_code", scapiShortCode));
            }
            if (scapiScopes != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "scapi_scopes", scapiScopes));
            }
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<AccountConfigUpdate200Response> localVarResponse = await AccountConfigUpdateWithHttpInfoAsync(replaceParameters, newStoreUrl, newStoreKey, customLabel, bridgeUrl, storeRoot, dbTablesPrefix, userAgent, var3dcartPrivateKey, var3dcartAccessToken, var3dcartapiApiKey, amazonSpClientId, amazonSpClientSecret, amazonSpRefreshToken, amazonSpAwsRegion, amazonSpApiEnvironment, amazonSellerId, aspdotnetstorefrontApiUser, aspdotnetstorefrontApiPass, americommerceAppId, americommerceAppSecret, americommerceAccessToken, americommerceRefreshToken, bigcommerceapiAdminAccount, bigcommerceapiApiPath, bigcommerceapiApiKey, bigcommerceapiClientId, bigcommerceapiAccessToken, bigcommerceapiContext, bolApiKey, bolApiSecret, bolRetailerId, demandwareClientId, demandwareApiPassword, demandwareUserName, demandwareUserPassword, ebayClientId, ebayClientSecret, ebayRuname, ebayAccessToken, ebayRefreshToken, ebayEnvironment, ebaySiteId, ecwidAcessToken, ecwidStoreId, lazadaAppId, lazadaAppSecret, lazadaRefreshToken, lazadaRegion, etsyKeystring, etsySharedSecret, etsyAccessToken, etsyTokenSecret, etsyClientId, etsyRefreshToken, facebookAppId, facebookAppSecret, facebookAccessToken, facebookBusinessId, netoApiKey, netoApiUsername, shoplineAccessToken, shoplineAppKey, shoplineAppSecret, shoplineSharedSecret, shopifyAccessToken, shopifyClientId, shopifyApiKey, shopifyApiPassword, shopifySharedSecret, shopeePartnerId, shopeePartnerKey, shopeeShopId, shopeeRefreshToken, shopeeRegion, shopeeEnvironment, shoplazzaAccessToken, shoplazzaSharedSecret, mivaAccessToken, mivaSignature, miraklApiKey, shopwareAccessKey, unasApiKey, shopwareApiKey, shopwareApiSecret, bigcartelUserName, bigcartelPassword, bricklinkConsumerKey, bricklinkConsumerSecret, bricklinkToken, bricklinkTokenSecret, nopcommerceToken, nopcommerceSecret, volusionLogin, volusionPassword, walmartClientId, walmartClientSecret, walmartEnvironment, walmartChannelType, walmartRegion, walmartRefreshToken, walmartSellerId, squareClientId, squareClientSecret, squareRefreshToken, squarespaceApiKey, squarespaceClientId, squarespaceClientSecret, squarespaceAccessToken, squarespaceRefreshToken, hybrisClientId, hybrisClientSecret, hybrisUsername, hybrisPassword, hybrisWebsites, lightspeedApiKey, lightspeedApiSecret, commercehqApiKey, commercehqApiPassword, wcConsumerKey, wcConsumerSecret, magentoConsumerKey, magentoConsumerSecret, magentoAccessToken, magentoTokenSecret, prestashopWebserviceKey, wixAppId, wixAppSecretKey, wixInstanceId, wixRefreshToken, mercadoLibreAppId, mercadoLibreAppSecretKey, mercadoLibreRefreshToken, zidClientId, zidClientSecret, zidAccessToken, zidAuthorization, zidRefreshToken, jumpsellerClientId, jumpsellerClientSecret, jumpsellerRefreshToken, jumpsellerLogin, jumpsellerAuthtoken, flipkartClientId, flipkartClientSecret, allegroClientId, allegroClientSecret, allegroAccessToken, allegroRefreshToken, allegroEnvironment, zohoClientId, zohoClientSecret, zohoRefreshToken, zohoRegion, tiendanubeUserId, tiendanubeAccessToken, tiendanubeClientSecret, ottoClientId, ottoClientSecret, ottoAppId, ottoRefreshToken, ottoEnvironment, ottoAccessToken, tiktokshopAppKey, tiktokshopAppSecret, tiktokshopRefreshToken, tiktokshopAccessToken, sallaClientId, sallaClientSecret, sallaRefreshToken, sallaAccessToken, temuAppKey, temuAppSecret, temuAccessToken, temuRegion, scapiClientId, scapiClientSecret, scapiOrganizationId, scapiShortCode, scapiScopes, idempotencyKey, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
