...
namespace Org.OpenAPITools.Api
{
    ...
    public interface IOrderApiSync : IApiAccessor
    {
        ...
        /// <param name="varParams">Important! Parameter deprecated, use response_fields instead. Set this parameter in order to choose which entity fields you want to retrieve (optional, default to &quot;customer,totals,items&quot;)</param>
        ...
        /// <param name="varParams">Important! Parameter deprecated, use response_fields instead. Set this parameter in order to choose which entity fields you want to retrieve (optional, default to &quot;order_id,customer,totals,address,items,bundles,status&quot;)</param>
        /// <param name="responseFields">Set this parameter to choose which entity fields to retrieve. Use comma-separated field names in curly braces, nested to match the response structure, e.g. {result{product{id,name}}}. The wildcard * returns every field at a level: {*} gives the whole response, {result{product{*}}} all product fields. (optional)</param>
        /// <param name="exclude">Important! Parameter deprecated, use response_fields instead. Set this parameter in order to choose which entity fields you want to ignore. Works only if parameter &#x60;params&#x60; equal force_all (optional)</param>
        ...
        /// <param name="storeId">Store Id (optional)</param>
        /// <param name="vendorId">Retrieves orders specified by vendor id (optional)</param>
        /// <param name="customerId">Retrieves orders specified by customer id (optional)</param>
        /// <param name="customerEmail">Retrieves orders specified by customer email (optional)</param>
        ...
        /// <param name="storeId">Store Id (optional)</param>
        /// <param name="responseFields">Set this parameter to choose which entity fields to retrieve. Use comma-separated field names in curly braces, nested to match the response structure, e.g. {result{product{id,name}}}. The wildcard * returns every field at a level: {*} gives the whole response, {result{product{*}}} all product fields. (optional)</param>
        /// <param name="varParams">Important! Parameter deprecated, use response_fields instead. Set this parameter in order to choose which entity fields you want to retrieve (optional, default to &quot;id,order_id,items,tracking_numbers&quot;)</param>
        /// <param name="exclude">Important! Parameter deprecated, use response_fields instead. Set this parameter in order to choose which entity fields you want to ignore. Works only if parameter &#x60;params&#x60; equal force_all (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        ...
        /// <param name="pageCursor">Used to retrieve entities via cursor-based pagination (it can&#39;t be used with any other filtering parameter) (optional)</param>
        /// <param name="storeId">Store Id (optional)</param>
        /// <param name="varParams">Important! Parameter deprecated, use response_fields instead. Set this parameter in order to choose which entity fields you want to retrieve (optional, default to &quot;id,order_id,amount,description&quot;)</param>
        /// <param name="responseFields">Set this parameter to choose which entity fields to retrieve. Use comma-separated field names in curly braces, nested to match the response structure, e.g. {result{product{id,name}}}. The wildcard * returns every field at a level: {*} gives the whole response, {result{product{*}}} all product fields. (optional)</param>
        /// <param name="exclude">Important! Parameter deprecated, use response_fields instead. Set this parameter in order to choose which entity fields you want to ignore. Works only if parameter &#x60;params&#x60; equal force_all (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
    ...
    public partial class OrderApi : IOrderApi
    {
        ...
        public Org.OpenAPITools.Client.ApiResponse<ModelResponseOrderCount> OrderCountWithHttpInfo(string? orderIds = default(string?), string? ids = default(string?), string? customerId = default(string?), string? storeId = default(string?), string? customerEmail = default(string?), string? orderStatus = default(string?), List<string>? orderStatusIds = default(List<string>?), string? ebayOrderStatus = default(string?), string? financialStatus = default(string?), List<string>? financialStatusIds = default(List<string>?), string? fulfillmentChannel = default(string?), string? fulfillmentStatus = default(string?), string? shippingMethod = default(string?), string? deliveryMethod = default(string?), string? tags = default(string?), string? shipNodeType = default(string?), string? createdFrom = default(string?), string? createdTo = default(string?), string? modifiedFrom = default(string?), string? modifiedTo = default(string?), bool? useLatestApiVersion = default(bool?), string? vendorId = default(string?), int operationIndex = 0)
        {
            ...
            if (vendorId != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "vendor_id", vendorId));
            }
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<ModelResponseOrderList> localVarResponse = await OrderListWithHttpInfoAsync(start, count, pageCursor, ids, orderIds, sinceId, storeId, vendorId, customerId, customerEmail, basketId, currencyId, phone, orderStatus, orderStatusIds, ebayOrderStatus, financialStatus, financialStatusIds, fulfillmentStatus, returnStatus, fulfillmentChannel, shippingMethod, skipOrderIds, isDeleted, shippingCountryIso3, deliveryMethod, shipNodeType, createdTo, createdFrom, modifiedTo, modifiedFrom, tags, sortBy, sortDirection, varParams, responseFields, exclude, enableCache, useLatestApiVersion, roundingPrecision, allowUserDefinedOrderStatuses, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
