...
namespace Org.OpenAPITools.Api
{
    ...
    public interface IOrderApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<OrderInfo200Response> OrderInfoAsync(string? id = default(string?), string? orderId = default(string?), string? storeId = default(string?), string? varParams = default(string?), string? responseFields = default(string?), string? exclude = default(string?), bool? enableCache = default(bool?), bool? useLatestApiVersion = default(bool?), int? roundingPrecision = default(int?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
    ...
    public partial class OrderApi : IOrderApi
    {
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<OrderInfo200Response> localVarResponse = OrderInfoWithHttpInfo(id, orderId, storeId, varParams, responseFields, exclude, enableCache, useLatestApiVersion, roundingPrecision);
            return localVarResponse.Data;
        }
        ...
        {
            Org.OpenAPITools.Client.ApiResponse<OrderInfo200Response> localVarResponse = await OrderInfoWithHttpInfoAsync(id, orderId, storeId, varParams, responseFields, exclude, enableCache, useLatestApiVersion, roundingPrecision, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
