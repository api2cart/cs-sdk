...
namespace Org.OpenAPITools.Api
{
    ...
    public interface ICategoryApiSync : IApiAccessor
    {
        ...
        /// <param name="varParams">Important! Parameter deprecated, use response_fields instead. Set this parameter in order to choose which entity fields you want to retrieve (optional, default to &quot;id,parent_id,name,description&quot;)</param>
