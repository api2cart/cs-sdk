...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class WebhookUpdate : IValidatableObject
    {
        ...
        public WebhookUpdate(string id = default(string), string callback = default(string), string label = default(string), string fields = default(string), string responseFields = default(string), bool active = default(bool), string langId = default(string), ParamDefinitionFilteringConditionsFilterCondition filteringConditions = default(ParamDefinitionFilteringConditionsFilterCondition), string idempotencyKey = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for WebhookUpdate and cannot be null");
            }
            this.Id = id;
