...
namespace Org.OpenAPITools.Model
{
    ...
    /// ProductAddBatch
    /// </summary>
    [DataContract(Name = "ProductAddBatch")]
    public partial class ProductAddBatch : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductAddBatch" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProductAddBatch() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductAddBatch" /> class.
        /// </summary>
        ...
        public ProductAddBatch(NestedItemsUpdateBehaviourEnum? nestedItemsUpdateBehaviour = NestedItemsUpdateBehaviourEnum.Replace, bool clearCache = false, bool reindex = false, List<ProductAddBatchPayloadInner> payload = default(List<ProductAddBatchPayloadInner>), string idempotencyKey = default(string))
        {
            // to ensure "payload" is required (not null)
            if (payload == null)
            {
                throw new ArgumentNullException("payload is a required property for ProductAddBatch and cannot be null");
            }
        ...
        public List<ProductAddBatchPayloadInner> Payload { get; set; }
