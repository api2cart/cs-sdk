...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ProductAddBatch : IValidatableObject
    {
        ...
        public ProductAddBatch(NestedItemsUpdateBehaviourEnum? nestedItemsUpdateBehaviour = NestedItemsUpdateBehaviourEnum.Replace, bool clearCache = false, bool reindex = false, List<ProductAddBatchPayloadInner> payload = default(List<ProductAddBatchPayloadInner>))
        {
