...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OrderInfo_200_response")]
    public partial class OrderInfo200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderInfo200Response" /> class.
        /// </summary>
        /// <param name="returnCode">returnCode.</param>
        /// <param name="returnMessage">returnMessage.</param>
        /// <param name="result">result.</param>
        public OrderInfo200Response(int returnCode = default(int), string returnMessage = default(string), Order result = default(Order))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OrderInfo200Response {\n");
