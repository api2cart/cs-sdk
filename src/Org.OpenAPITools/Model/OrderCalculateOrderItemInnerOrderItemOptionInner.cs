...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OrderCalculate_order_item_inner_order_item_option_inner")]
    public partial class OrderCalculateOrderItemInnerOrderItemOptionInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderCalculateOrderItemInnerOrderItemOptionInner" /> class.
        /// </summary>
        ...
        public OrderCalculateOrderItemInnerOrderItemOptionInner(string orderItemOptionName = default(string), string orderItemOptionValue = default(string))
        {
