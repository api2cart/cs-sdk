...
namespace Org.OpenAPITools.Model
{
    ...
    /// CustomerConsent
    /// </summary>
    [DataContract(Name = "Customer_Consent")]
    public partial class CustomerConsent : IValidatableObject
    {
        ...
        /// <param name="optInLevel">optInLevel.</param>
        /// <param name="modifiedTime">modifiedTime.</param>
        /// <param name="additionalFields">additionalFields.</param>
        /// <param name="customFields">customFields.</param>
        public CustomerConsent(string id = default(string), string type = default(string), string status = default(string), string source = default(string), string optInLevel = default(string), string modifiedTime = default(string), Object additionalFields = default(Object), Object customFields = default(Object))
        {
            this.Id = id;
            this.Type = type;
            this.Status = status;
