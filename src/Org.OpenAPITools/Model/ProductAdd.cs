...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ProductAdd : IValidatableObject
    {
        ...
        */
        ...
        /// </summary>
        /// <value>Defines personalization questions for the listing as an array of question objects. Each question object supports the following fields: question_id (integer, nullable), question_text (string, 1-45 chars), instructions (string, nullable), question_type (string), required (boolean), max_allowed_characters (integer, nullable), max_allowed_files (integer, nullable), options (array, nullable). Cannot be used together with &lt;strong&gt;personalization_details&lt;/strong&gt;.</value>
        [DataMember(Name = "personalization_questions", EmitDefaultValue = false)]
        public List<ProductAddPersonalizationQuestionsInner> PersonalizationQuestions { get; set; }
        ...
        */
        [DataMember(Name = "manufacturer_ids", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>A comma-separated list of responsible person IDs. Retrieve the IDs from the cart.info method.</value>
        /*
        <example>1,2,3</example>
        */
        [DataMember(Name = "responsible_person_ids", EmitDefaultValue = false)]
        public string ResponsiblePersonIds { get; set; }
