...
namespace Org.OpenAPITools.Model
{
    ...
    /// ProductUpdateBatch
    /// </summary>
    [DataContract(Name = "ProductUpdateBatch")]
    public partial class ProductUpdateBatch : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductUpdateBatch" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProductUpdateBatch() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductUpdateBatch" /> class.
        /// </summary>
        ...
        public ProductUpdateBatch(NestedItemsUpdateBehaviourEnum? nestedItemsUpdateBehaviour = NestedItemsUpdateBehaviourEnum.Replace, bool clearCache = false, bool reindex = false, List<ProductUpdateBatchPayloadInner> payload = default(List<ProductUpdateBatchPayloadInner>), string idempotencyKey = default(string))
        {
            // to ensure "payload" is required (not null)
            if (payload == null)
            {
                throw new ArgumentNullException("payload is a required property for ProductUpdateBatch and cannot be null");
            }
        ...
        public List<ProductUpdateBatchPayloadInner> Payload { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProductUpdateBatch {\n");
