...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ProductVariantUpdateBatch : IValidatableObject
    {
        ...
        public ProductVariantUpdateBatch(NestedItemsUpdateBehaviourEnum? nestedItemsUpdateBehaviour = NestedItemsUpdateBehaviourEnum.Replace, bool clearCache = false, bool reindex = false, List<ProductVariantUpdateBatchPayloadInner> payload = default(List<ProductVariantUpdateBatchPayloadInner>), string idempotencyKey = default(string))
        {
