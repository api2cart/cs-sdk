...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ProductVariantAddBatch : IValidatableObject
    {
        ...
        public ProductVariantAddBatch(bool clearCache = false, bool reindex = false, List<ProductVariantAddBatchPayloadInner> payload = default(List<ProductVariantAddBatchPayloadInner>), string idempotencyKey = default(string))
        {
