...
# **AccountCartList**
> AccountCartList200Response AccountCartList (string? varParams = null, string? exclude = null, string? requestFromDate = null, string? requestToDate = null, string? storeUrl = null, string? storeKey = null)
...
namespace Example
{
    public class AccountCartListExample
    {
        public static void Main()
        {
            ...
            {
                // account.cart.list
                AccountCartList200Response result = apiInstance.AccountCartList(varParams, exclude, requestFromDate, requestToDate, storeUrl, storeKey);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // account.cart.list
    ApiResponse<AccountCartList200Response> response = apiInstance.AccountCartListWithHttpInfo(varParams, exclude, requestFromDate, requestToDate, storeUrl, storeKey);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
> AccountFailedWebhooks200Response AccountFailedWebhooks (int? count = null, int? start = null, string? ids = null)
...
{
    // account.failed_webhooks
    ApiResponse<AccountFailedWebhooks200Response> response = apiInstance.AccountFailedWebhooksWithHttpInfo(count, start, ids);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
