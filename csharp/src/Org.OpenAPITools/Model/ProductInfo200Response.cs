...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProductInfo_200_response")]
    public partial class ProductInfo200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductInfo200Response" /> class.
        /// </summary>
        /// <param name="returnCode">returnCode.</param>
        /// <param name="returnMessage">returnMessage.</param>
        /// <param name="result">result.</param>
        public ProductInfo200Response(int returnCode = default(int), string returnMessage = default(string), Product result = default(Product))
        {
