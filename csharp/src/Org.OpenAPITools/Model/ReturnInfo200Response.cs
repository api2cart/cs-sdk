...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ReturnInfo_200_response")]
    public partial class ReturnInfo200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReturnInfo200Response" /> class.
        /// </summary>
        /// <param name="returnCode">returnCode.</param>
        /// <param name="returnMessage">returnMessage.</param>
        /// <param name="result">result.</param>
        public ReturnInfo200Response(int returnCode = default(int), string returnMessage = default(string), Return result = default(Return))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReturnInfo200Response {\n");
