...
*AnalyticsApi* | [**AnalyticsCustomerReport**](docs/AnalyticsApi.md#analyticscustomerreport) | **GET** /analytics.customer_report.json | analytics.customer_report
*AnalyticsApi* | [**AnalyticsProductReport**](docs/AnalyticsApi.md#analyticsproductreport) | **GET** /analytics.product_report.json | analytics.product_report
*AnalyticsApi* | [**AnalyticsReport**](docs/AnalyticsApi.md#analyticsreport) | **GET** /analytics.report.json | analytics.report
...
## Documentation for Models
 ...
 - [Model.AccountSupportedPlatform](docs/AccountSupportedPlatform.md)
 - [Model.AccountSupportedPlatformParams](docs/AccountSupportedPlatformParams.md)
 - [Model.AccountSupportedPlatformParamsRequiredInnerInner](docs/AccountSupportedPlatformParamsRequiredInnerInner.md)
 - [Model.AnalyticsCustomer](docs/AnalyticsCustomer.md)
 - [Model.AnalyticsCustomerMetric](docs/AnalyticsCustomerMetric.md)
 - [Model.AnalyticsInterval](docs/AnalyticsInterval.md)
 - [Model.AnalyticsMetric](docs/AnalyticsMetric.md)
 - [Model.AnalyticsPeriod](docs/AnalyticsPeriod.md)
 - [Model.AnalyticsProduct](docs/AnalyticsProduct.md)
 - [Model.AnalyticsProductMetric](docs/AnalyticsProductMetric.md)
 ...
 - [Model.ModelResponseAccountSupportedPlatforms](docs/ModelResponseAccountSupportedPlatforms.md)
 - [Model.ModelResponseAttributeAttributesetList](docs/ModelResponseAttributeAttributesetList.md)
 - [Model.ModelResponseAttributeCount](docs/ModelResponseAttributeCount.md)
 ...
 - [Model.ModelResponseAttributeTypeList](docs/ModelResponseAttributeTypeList.md)
 - [Model.ModelResponseBatchJobList](docs/ModelResponseBatchJobList.md)
 - [Model.ModelResponseCartCatalogPriceRulesCount](docs/ModelResponseCartCatalogPriceRulesCount.md)
 - [Model.ModelResponseCartCatalogPriceRulesList](docs/ModelResponseCartCatalogPriceRulesList.md)
 - [Model.ModelResponseCartCouponCount](docs/ModelResponseCartCouponCount.md)
 ...
 - [Model.ModelResponseCartGiftcardCount](docs/ModelResponseCartGiftcardCount.md)
 - [Model.ModelResponseCartMetaDataList](docs/ModelResponseCartMetaDataList.md)
 - [Model.ModelResponseCartMethods](docs/ModelResponseCartMethods.md)
 ...
 - [Model.ModelResponseCategoryAssign](docs/ModelResponseCategoryAssign.md)
 - [Model.ModelResponseCategoryCount](docs/ModelResponseCategoryCount.md)
 - [Model.ModelResponseCategoryFind](docs/ModelResponseCategoryFind.md)
 - [Model.ModelResponseCategoryList](docs/ModelResponseCategoryList.md)
 - [Model.ModelResponseCategoryUnassign](docs/ModelResponseCategoryUnassign.md)
 - [Model.ModelResponseCustomerAttributeList](docs/ModelResponseCustomerAttributeList.md)
 - [Model.ModelResponseCustomerCount](docs/ModelResponseCustomerCount.md)
 - [Model.ModelResponseCustomerFind](docs/ModelResponseCustomerFind.md)
 ...
 - [Model.ModelResponseOrderCount](docs/ModelResponseOrderCount.md)
 - [Model.ModelResponseOrderFinancialStatusList](docs/ModelResponseOrderFinancialStatusList.md)
 - [Model.ModelResponseOrderFulfillmentStatusList](docs/ModelResponseOrderFulfillmentStatusList.md)
 ...
 - [Model.ModelResponseOrderShipmentEventList](docs/ModelResponseOrderShipmentEventList.md)
 ...
 - [Model.ModelResponseProductChildItemFind](docs/ModelResponseProductChildItemFind.md)
 - [Model.ModelResponseProductChildItemList](docs/ModelResponseProductChildItemList.md)
 - [Model.ModelResponseProductCount](docs/ModelResponseProductCount.md)
 - [Model.ModelResponseProductCurrencyList](docs/ModelResponseProductCurrencyList.md)
 - [Model.ModelResponseProductFind](docs/ModelResponseProductFind.md)
 ...
 - [Model.ModelResponseReturnActionList](docs/ModelResponseReturnActionList.md)
 - [Model.ModelResponseReturnCount](docs/ModelResponseReturnCount.md)
 - [Model.ModelResponseReturnList](docs/ModelResponseReturnList.md)
 - [Model.ModelResponseReturnReasonList](docs/ModelResponseReturnReasonList.md)
 - [Model.ModelResponseReturnStatusList](docs/ModelResponseReturnStatusList.md)
 ...
 - [Model.ModelResponseWebhookCount](docs/ModelResponseWebhookCount.md)
 - [Model.ModelResponseWebhookEvents](docs/ModelResponseWebhookEvents.md)
 ...
 - [Model.OrderShipmentEventAdd](docs/OrderShipmentEventAdd.md)
 ...
 - [Model.ParamDefinitionFilteringConditionsFilterCondition](docs/ParamDefinitionFilteringConditionsFilterCondition.md)
 - [Model.ParamDefinitionFilteringConditionsFilterGroup](docs/ParamDefinitionFilteringConditionsFilterGroup.md)
 - [Model.ParamDefinitionFilteringConditionsFilterRule](docs/ParamDefinitionFilteringConditionsFilterRule.md)
 - [Model.ParamDefinitionFilteringConditionsFilterRuleValue](docs/ParamDefinitionFilteringConditionsFilterRuleValue.md)
 ...
 - [Model.ResponseAccountSupportedPlatformsResult](docs/ResponseAccountSupportedPlatformsResult.md)
 - [Model.ResponseAnalyticsCustomerReportResult](docs/ResponseAnalyticsCustomerReportResult.md)
 - [Model.ResponseAnalyticsProductReportResult](docs/ResponseAnalyticsProductReportResult.md)
 - [Model.ResponseAnalyticsReportResult](docs/ResponseAnalyticsReportResult.md)
 - [Model.ResponseAttributeAttributesetListResult](docs/ResponseAttributeAttributesetListResult.md)
 - [Model.ResponseAttributeCountResult](docs/ResponseAttributeCountResult.md)
 ...
 - [Model.ResponseAttributeTypeListResult](docs/ResponseAttributeTypeListResult.md)
 ...
 - [Model.ResponseCartCatalogPriceRulesCountResult](docs/ResponseCartCatalogPriceRulesCountResult.md)
 - [Model.ResponseCartCatalogPriceRulesListResult](docs/ResponseCartCatalogPriceRulesListResult.md)
 - [Model.ResponseCartCouponCountResult](docs/ResponseCartCouponCountResult.md)
 - [Model.ResponseCartCouponListResult](docs/ResponseCartCouponListResult.md)
 - [Model.ResponseCartGiftcardCountResult](docs/ResponseCartGiftcardCountResult.md)
 ...
 - [Model.ResponseCartMethodsResult](docs/ResponseCartMethodsResult.md)
 ...
 - [Model.ResponseCategoryAssignResult](docs/ResponseCategoryAssignResult.md)
 - [Model.ResponseCategoryCountResult](docs/ResponseCategoryCountResult.md)
 - [Model.ResponseCategoryFindResult](docs/ResponseCategoryFindResult.md)
 - [Model.ResponseCategoryListResult](docs/ResponseCategoryListResult.md)
 - [Model.ResponseCategoryUnassignResult](docs/ResponseCategoryUnassignResult.md)
 - [Model.ResponseCustomerAttributeListResult](docs/ResponseCustomerAttributeListResult.md)
 - [Model.ResponseCustomerCountResult](docs/ResponseCustomerCountResult.md)
 - [Model.ResponseCustomerFindResult](docs/ResponseCustomerFindResult.md)
 ...
 - [Model.ResponseOrderCountResult](docs/ResponseOrderCountResult.md)
 - [Model.ResponseOrderFinancialStatusListResult](docs/ResponseOrderFinancialStatusListResult.md)
 - [Model.ResponseOrderFulfillmentStatusListResult](docs/ResponseOrderFulfillmentStatusListResult.md)
 ...
 - [Model.ResponseOrderShipmentEventListResult](docs/ResponseOrderShipmentEventListResult.md)
 ...
 - [Model.ResponseProductChildItemFindResult](docs/ResponseProductChildItemFindResult.md)
 - [Model.ResponseProductChildItemListResult](docs/ResponseProductChildItemListResult.md)
 - [Model.ResponseProductCountResult](docs/ResponseProductCountResult.md)
 - [Model.ResponseProductCurrencyListResult](docs/ResponseProductCurrencyListResult.md)
 - [Model.ResponseProductFindResult](docs/ResponseProductFindResult.md)
 ...
 - [Model.ResponseReturnActionListResult](docs/ResponseReturnActionListResult.md)
 - [Model.ResponseReturnCountResult](docs/ResponseReturnCountResult.md)
 - [Model.ResponseReturnListResult](docs/ResponseReturnListResult.md)
 - [Model.ResponseReturnReasonListResult](docs/ResponseReturnReasonListResult.md)
 - [Model.ResponseReturnStatusListResult](docs/ResponseReturnStatusListResult.md)
 ...
 - [Model.ResponseWebhookCountResult](docs/ResponseWebhookCountResult.md)
 - [Model.ResponseWebhookEventsResult](docs/ResponseWebhookEventsResult.md)
 ...
 - [Model.ShipmentEvent](docs/ShipmentEvent.md)
